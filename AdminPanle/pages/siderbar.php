            ...
            <div class="fixed w-[20%] h-full shadow-xl pt-8 bg-[#ffffff]">
                ...
                <div class="mt-20 px-6">
                    <ul class="w-full">
                        ...
                        <li class="mb-4 rounded-lg text-base hover:bg-[#e5e7eb] py-2 px-3"><a href=""><i class="fa-solid fa-road w-9 h-9 bg-[#eeeeee] shadow-xl rounded-lg text-center  pt-3"></i> Routes</a></li>
