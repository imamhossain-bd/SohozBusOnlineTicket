...
<body>
    <section>
        <div class="bg-[url('https://i.ibb.co.com/vcngT3H/air-web-top-new.png')] bg-cover bg-center h-[19rem] pt-36 px-[10rem]">
            <div class="bg-[#fffffff2] mx-sm:p-2 max-w-full mx-auto relative w-full rounded-3xl h-[135px]">
                <div class="flex ml-7 pt-5 items-center space-x-4 mb-4">
                    <label class="flex items-center space-x-2">
                        <input type="radio" name="tripType" class="h-5 w-5 text-black" checked>
